...
public class Constant {
	...
	public static final String VERY_UNDERWEIGHT = "SANGAT KURUS";

	public static final String UNDERWEIGHT = "KURUS";

	public static final String OVERWEIGHT = "GEMUK";

	public static final String VERY_OVERWEIGHT = "SANGAT GEMUK";
	
	public static final String VERY_UNDERLENGTH = "SANGAT KURANG TINGGI";

	public static final String UNDERLENGTH = "KURANG TINGGI";

	public static final String OVERLENGTH = "TINGGI";

	public static final String VERY_OVERLENGTH = "SANGAT TINGGI";

	public static final String VERY_MIKROSEFALI = "MIKROSEFALI";

	public static final String MIKROSEFALI = "MIKROSEFALI";

	public static final String MAKROSEFALI = "MAKROSEFALI";

	public static final String VERY_MAKROSEFALI = "MAKROSEFALI";
