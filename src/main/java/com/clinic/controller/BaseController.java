...
public class BaseController {
	 ...
	 public APIRequest < UploadRequest > geUploadRequest(String content) throws Exception {
		 Gson gson = new Gson();
		 Type fooType = new TypeToken<APIRequest< UploadRequest >>(){}.getType();
		 LOG.info("REQ::{}", content.toString());
		 return gson.fromJson(content, fooType);
	 } 
	 
	 public APIRequest < ChangePasswordRequest > getChangePasswordRequest(String content) throws Exception {
		 Gson gson = new Gson();
		 Type fooType = new TypeToken<APIRequest< ChangePasswordRequest >>(){}.getType();
		 LOG.info("REQ::{}", content.toString());
		 return gson.fromJson(content, fooType);
	 } 
}	
